...
describe('Centaur', function() {
  ...
  it('should have a name', function() {
    var centaur = new Centaur({ name: 'Kristi', type: 'Palomino' });
    var centaur2 = new Centaur({ name: 'Blanche', type: 'Thoroughbred' });

    assert.equal(centaur.name, 'Kristi');
    assert.equal(centaur2.name, 'Blanche');
  });
